...
public class VendingMachine {
     ...
     * 1.  If the name is not a valid product name, throws a IllegalArgumentException with message
     *     "Invalid name"
     * 2.  If there is no stock, throws a labtest.vending.exception.OutOfStockException with message "No Stock"
     * 3.  If customerCash is insufficient to purchase the product, throws a InsufficientMoneyException
     * 4.  If there is a matching product, and the customer has sufficient cash,
     *     decrement the product stock quantity by 1, and deduct the product's price from customerCash
     */
